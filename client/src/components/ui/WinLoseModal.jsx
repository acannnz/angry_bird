...
export function WinLoseModal() {
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-300">
      <div className="relative w-full max-w-md rounded-3xl bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 border-2 border-amber-500/40 p-6 shadow-2xl shadow-amber-500/10 text-center text-white">
        
        {/* Header Icon */}
        <div className="mx-auto -mt-14 mb-3 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-tr from-amber-600 to-yellow-400 shadow-xl shadow-amber-500/30 border-4 border-slate-900">
          {isWon ? (
            <Trophy className="h-10 w-10 text-slate-950 stroke-[2.5]" />
          ) : (
            <Frown className="h-10 w-10 text-slate-950 stroke-[2.5]" />
          )}
        </div>
        ...
        <div className="my-4 rounded-2xl bg-slate-950/70 p-4 border border-slate-800/80 text-left">
          {isWon && (
            <div className="space-y-1.5 pb-2.5 mb-2.5 border-b border-slate-800 text-xs">
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          <button
            onClick={resetLevel}
            className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold py-3 px-4 transition-all duration-200 shadow-md active:scale-95 border border-slate-700 cursor-pointer"
          >
          ...
          {isWon && (
            <button
              onClick={nextLevel}
              className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-400 hover:from-amber-400 hover:to-yellow-300 text-slate-950 font-black py-3 px-4 transition-all duration-200 shadow-lg shadow-amber-500/20 active:scale-95 cursor-pointer"
            >
              <span>Lanjut</span>
